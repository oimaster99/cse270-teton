...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    ...
    self.driver.set_window_size(960, 692)
    elements = self.driver.find_elements(By.ID, "username")
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("Mark")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("Grayson")
  ...
  def test_joinPage(self):
    ...
    self.driver.set_window_size(732, 692)
    ...
    self.driver.find_element(By.NAME, "bizname").send_keys("Gangsta Business")
